...
//     return <Navigate to="/" />; // Redirect to homepage if the role is not allowed
//   }
...
//           path="/flightowner-dashboard/*"
//           element={
//             <ProtectedRoute rolesAllowed={["FlightOwner"]}>
//               <FlightOwnerDashboard />
//             </ProtectedRoute>
//           }
//         >
...
//           <Route path="booking-history" element={<BookingHistory />} />
//           <Route path="bookings" element={<Bookings />} />
//           <Route path="add-new-flight" element={<AddNewFlight />} />
//           <Route path="get-all-flights" element={<GetAllFlights />} /> {/* Example route for viewing flights */}
//         </Route>
...
import ContactUs from "./Pages/ContactUs"; // Import Contact Us Component
import "./App.css";
